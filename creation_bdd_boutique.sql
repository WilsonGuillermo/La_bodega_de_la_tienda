...
CREATE TABLE IF NOT EXISTS roles (
	...
	nombre_del_role VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS referencia_ingredientes (
    ...
    FOREIGN KEY (id_ref) REFERENCES referencia_tipos_ingredientes(id),
    CONSTRAINT UC_referencia_ingredientes UNIQUE(id, nombre)
)ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS ingredientes (
    ...
    FOREIGN KEY (id_tipo) REFERENCES referencia_tipos_ingredientes(id),
    FOREIGN KEY (id_producto) REFERENCES referencia_ingredientes(id),

...
import enchainment_pages as principal
...
class identificacion(tk.Tk):
    ...
    def celula_de_identificacion(self):
        ...
        if papel == 'Admin':
            """ Administrador """
            self.madre.show_page2()
        elif papel == 'Cocinero':
            """ Concinero """
            #self.madre.login_page.cerrar_frame()
            #self.cerrar_frame()
            #self.cocina = micocina.cocina()
            self.micocina.crear_componentes_cocina()
            #self.cocina.crear_componentes_cocina()
        elif papel == 'Mesero':
            """ Mesero """
